...
import com.brenohff.cursomc.exception.ObjectNotFound;
...
public class CategoryService {
    ...
    public CategoryEntity getCategoryById(Integer categoryId) {
        ...
        return category.orElseThrow(() -> new ObjectNotFound(String.format("Object %s not found with id %d", CategoryService.class.getTypeName(), categoryId)));
    }
